...
import defaultAbi from "./templates/Aep17TemplateAbi.json";

/**
 * A standard AEP-17 contract according to specification.
 */
export class Aep17Contract extends BaseContract {
  /**
   * The list of methods found on the AEP-5 specification.
   */
  ...
  constructor(
    ...
    super(scriptHash, Aep17Contract.getMethods().concat(additionalMethods));
  }
   ...
   *
   * @example
   * const contract = new Aep17Contract(contractHash);
