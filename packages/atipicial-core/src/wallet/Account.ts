...
import { decrypt, encrypt, ScryptParams } from "./aep2";
import {
  isAddress,
  isAEP2,
  isPrivateKey,
 ...
 *
 * ```
 * AEP2 <=> WIF <=> Private => Public => ScriptHash <=> Address
 * ```
 *
 ...
 */
export class Account implements AtipicialObject<AccountJSON> {
  /**
  ...
  /**
   * Key encrypted according to AEP2 standard.
   *
