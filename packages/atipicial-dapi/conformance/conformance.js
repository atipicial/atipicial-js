...
const signMessageTest = {
  ...
  tag: "interactive",
  fn: async (provider) => {
    const signedMessage = await provider.signMessage("Hello Atipicial");
...
const makeTransactionTest = {
  ...
  fn: async (provider) => {
    ...
    assert(
      context.type === "Atipicial.Network.P2P.Payloads.Transaction",
      'context.type must be "Atipicial.Network.P2P.Payloads.Transaction", got ' +
        toJson(context.type),
    );
    assert(
...
const signTest = {
  ...
  fn: async (provider) => {
    ...
    assert(
      signedContext.type === "Atipicial.Network.P2P.Payloads.Transaction",
      'signedContext.type must be "Atipicial.Network.P2P.Payloads.Transaction", got ' +
