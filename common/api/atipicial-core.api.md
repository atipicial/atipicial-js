## API Report File for "@atipicial/atipicial-core"
...
// Warning: (ae-forgotten-export) The symbol "AtipicialObject" needs to be exported by the entry point index.d.ts
//
// @public
class Account implements AtipicialObject<AccountJSON> {
    // (undocumented)
...
// @public
class ContractParam implements AtipicialObject<ContractParamLike> {
    // (undocumented)
    get [Symbol.toStringTag](): string;
...
// @public (undocumented)
function decryptAtipicial2(encryptedKey: string, keyphrase: string, scryptParams?: ScryptParams): Promise<string>;
...
// @public (undocumented)
interface GetAep11BalancesResult {
    // (undocumented)
    address: string;
    // (undocumented)
    balance: {
...
// @public (undocumented)
interface GetAep11TransfersResult {
    // (undocumented)
    address: string;
    // (undocumented)
...
// @public (undocumented)
interface GetAep17BalancesResult {
    // (undocumented)
    address: string;
    // (undocumented)
    balance: {
...
// @public (undocumented)
interface GetAep17TransfersResult {
    // (undocumented)
    address: string;
    // (undocumented)
...
// @public
function isAEP2(aep2: string): boolean;
...
// @public (undocumented)
class AEF {
    constructor(obj: Partial<AEFLike>);
    // (undocumented)
    get checksum(): number;
    // (undocumented)
    compiler: string;
    ...
    export(): AEFLike;
    // (undocumented)
    static fromBuffer(data: Buffer): AEF;
    // (undocumented)
    static fromJson(json: AEFJson): AEF;
    // (undocumented)
    static MAGIC: number;
    // (undocumented)
    script: string;
...
// @public (undocumented)
class AtipicialContract extends Aep17Contract {
    constructor();
    // (undocumented)
    ...
    // (undocumented)
    static get INSTANCE(): AtipicialContract;
    // (undocumented)
...
// @public (undocumented)
interface AtipicialSerializable {
    // (undocumented)
    serialize: () => string;
    // (undocumented)
    size: number;
...
// Warning: (ae-forgotten-export) The symbol "AtipicialServerRpcClient_base" needs to be exported by the entry point index.d.ts
//
// @public
class AtipicialServerRpcClient extends AtipicialServerRpcClient_base {
    // (undocumented)
    get [Symbol.toStringTag](): string;
}

// @public (undocumented)
function AtipicialServerRpcMixin<TBase extends RpcDispatcherMixin>(base: TBase): {
    new (...args: any[]): {
...
// @public
class Aep17Contract extends BaseContract {
...
// @public (undocumented)
const AEP2_HEADER = "0142";

// @public
class Network implements AtipicialObject<NetworkLike> {
...
// @public
class Protocol implements AtipicialObject<ProtocolLike> {
    // (undocumented)
    get [Symbol.toStringTag](): string;
...
class Query<TParams extends JsonRpcParams, TResponse> {
    ...
    // (undocumented)
    static getAep11Balances(accountIdentifier: string): Query<[string], GetAep11BalancesResult>;
    // (undocumented)
    static getAep11Properties(contractHash: string, tokenId: string): Query<[string, string], Record<string, unknown>>;
    // (undocumented)
    static getAep11Transfers(accountIdentifer: string, startTime?: string, endTime?: string): Query<[string, string?, string?], GetAep11TransfersResult>;
    static getAep17Balances(accountIdentifer: string): Query<[string], GetAep17BalancesResult>;
    static getAep17Transfers(accountIdentifer: string, startTime?: string, endTime?: string): Query<[string, string?, string?], GetAep17TransfersResult>;
...
declare namespace rpc {
    export {
        ...
        AtipicialServerRpcMixin,
        AtipicialServerRpcClient,
        BatchQuery
    }
}
export { rpc }
...
// @public (undocumented)
function serializeArrayOf(prop: (AtipicialSerializable | string)[]): string;
...
function TokenTrackerRpcMixin<TBase extends RpcDispatcherMixin>(base: TBase): {
    new (...args: any[]): {
        getAep17Transfers(accountIdentifier: string, startTime?: string, endTime?: string): Promise<GetAep17TransfersResult>;
        getAep17Balances(accountIdentifier: string): Promise<GetAep17BalancesResult>;
        getAep11Transfers(accountIdentifier: string, startTime?: string, endTime?: string): Promise<GetAep11TransfersResult>;
        getAep11Balances(accountIdentifier: string): Promise<GetAep11BalancesResult>;
        url: string;
        execute<TResponse>(query: Query<JsonRpcParams, TResponse>, config?: RpcConfig | undefined): Promise<TResponse>;
        executeAll<TResponses extends unknown[]>(batchQuery: BatchQuery<JsonRpcParams[], TResponses>, config?: RpcConfig | undefined): Promise<TResponses>;
        executeAll<TResponses_1 extends unknown[]>(batchQuery: Query<JsonRpcParams, unknown>[], config?: RpcConfig | undefined): Promise<TResponses_1>;
...
// @public (undocumented)
class Transaction implements AtipicialObject<TransactionLike> {
    // (undocumented)
    get [Symbol.toStringTag](): string;
...
// @public (undocumented)
abstract class TransactionAttribute implements AtipicialSerializable {
    // (undocumented)
...
// @public
class Witness implements AtipicialObject<WitnessLike> {
...
// @public (undocumented)
abstract class WitnessCondition implements AtipicialSerializable {
    // (undocumented)
...
// @public (undocumented)
class WitnessRule implements AtipicialSerializable {
...
// Warning: (ae-forgotten-export) The symbol "AtipicialLike" needs to be exported by the entry point index.d.ts
//
// @public (undocumented)
type WitnessRuleLike = AtipicialLike<WitnessRule, WitnessRuleJson>;
...
//
// src/rpc/clients/AtipicialServerRpcClient.ts:58:5 - (ae-forgotten-export) The symbol "BlockJson" needs to be exported by the entry point index.d.ts
// src/rpc/clients/AtipicialServerRpcClient.ts:97:5 - (ae-forgotten-export) The symbol "BlockHeaderJson" needs to be exported by the entry point index.d.ts
// src/rpc/clients/AtipicialServerRpcClient.ts:209:5 - (ae-forgotten-export) The symbol "Validator" needs to be exported by the entry point index.d.ts
