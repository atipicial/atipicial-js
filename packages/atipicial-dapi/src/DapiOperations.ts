import { rpc, tx, u, wallet } from "@atipicial/atipicial-core";
...
export class DapiOperations {
   ...
   * The authentication process is described in detail in AEP-20.
   ...
   * @param asset - The script hash of the AEP-17 token contract.
  ...
  /**
   * Gets symbol, decimals, and total supply of a AEP-17 token.
  ...
  /**
   * Transfers a AEP-17 asset and broadcasts the transaction.
   * @param asset - The script hash of the AEP-17 token contract.
  ...
  /**
   * Calculates the total fee (system + network) for a AEP-17 transfer without broadcasting it.
   * @param asset - The script hash of the AEP-17 token contract.
