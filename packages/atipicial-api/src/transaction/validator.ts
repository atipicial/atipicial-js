import { tx, rpc, u } from "@atipicial/atipicial-core";
...
export class TransactionValidator {
   ...
   */
  public rpcClient: rpc.AtipicialServerRpcClient;
  ...
  constructor(rpc: rpc.AtipicialServerRpcClient, transaction: tx.Transaction) {
    this.rpcClient = rpc;
