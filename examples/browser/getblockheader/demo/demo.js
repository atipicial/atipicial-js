...
// This is a reusable function that packages an unsupported RPC API call into a generic atipicial-js query object.
function rpcQuery(callback, url, method, parms) {
  ...
  const query = Atipicial.default.create.query({method: method, params: args});
