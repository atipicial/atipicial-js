...
import { AtipicialObject } from "../../model";
const log = logger("tx");
...
export class Transaction implements AtipicialObject<TransactionLike> {
  /**
   * Only version=0 is valid for ATIPICIAL
   */
   ...
   * If transaction only invokes native contracts, systemFee can be calculated offline. It is distributed to ATC holders.
   *
   * @example
