...
export enum WitnessScope {
   ...
   * This can be default safe choice for native ATC/GAS (previously used on Atipicial 2 as "attach" mode)
   */
  CalledByEntry = 1 << 0,
  ...
  /**
   * Global allows this witness in all contexts (default Atipicial2 behavior)
