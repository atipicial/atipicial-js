...
test("errors if nothing given", () => {
  expect(() => parse("atipicial:")).toThrow();
});
...
describe("parse", () => {
  test.each([
    [
      ...
      "atipicial:NNWAo5vdVJz1oyCuNiaTBA3amBHnWCF4Yk?asset=atipicial",
      {
        intent: "pay",
        description: "Transfer some ATC to NNWAo5vdVJz1oyCuNiaTBA3amBHnWCF4Yk",
        contractCall: {
    ...
    [
      ...
      "atipicial:NNWAo5vdVJz1oyCuNiaTBA3amBHnWCF4Yk?asset=d2a4cff31913016155e38e474a2c06d08be276cf",
      {
        intent: "pay",
        description:
    ...
    [
      ...
      "atipicial:NNWAo5vdVJz1oyCuNiaTBA3amBHnWCF4Yk?asset=gas&amount=1000",
      {
        intent: "pay",
