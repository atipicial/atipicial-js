import { AtipicialLike, parseEnum } from "../../internal";
import { AtipicialSerializable, StringStream } from "../../u";
import {
...
export type WitnessRuleLike = AtipicialLike<WitnessRule, WitnessRuleJson>;
export class WitnessRule implements AtipicialSerializable {
