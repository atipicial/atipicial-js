...
// Represents the type of Parameter. See AEP-14 for more details.
...
export type WitnessScope =
  ...
  | "Global" // This allows the witness in all contexts (default Atipicial2 behavior).
...
export interface DapiProvider {
  ...
  // It should include "AEP-21" if the provider supports this standard.
  // Example: ["AEP-11", "AEP-17", "AEP-21"]
