import { CONST, rpc, sc, u, wallet } from "@atipicial/atipicial-core";
import * as TestHelpers from "../../../testHelpers";
import testWallet from "../../atipicial-core/__tests__/testWallet.json";
...
describe("NetworkFacade", () => {
      ...
      [
        {
          ...
          contractHash: CONST.NATIVE_CONTRACT_HASH.AtipicialDollar,
  ...
  test("gasClaim", async () => {
    ...
    const unclaimedGasResult = await facade.invoke(
      sc.AtipicialContract.INSTANCE.unclaimedGas(acct.address, currentHeight),
    );
