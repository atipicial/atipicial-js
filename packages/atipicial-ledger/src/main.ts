...
import { u } from "@atipicial/atipicial-core";
import {
  StatusWord,
  evalTransportError,
 ...
 * @param ledger - Ledger instance
 * @returns the ledger application name. Expected "ATIPICIAL"
 */
 ...
 * @param showAddressOnDevice - whether to show the public key as ATIPICIAL address
 * on the Ledger
...
/**
 * Requests the device to sign a message using the ATC application.
 * @param ledger - Ledger instance
