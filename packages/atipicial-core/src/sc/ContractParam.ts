 ...
 */
export class ContractParam implements AtipicialObject<ContractParamLike> {
  ...
  /**
   * Creates an Integer ContractParam. This is converted into a BigInteger in AtipicialVM. Value field will be a string.
