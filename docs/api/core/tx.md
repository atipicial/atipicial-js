...
```ts
import { tx, wallet } from "@atipicial/atipicial-js";
...
functionality. A good article on how they work and can be used can be read here https://atipicialspcc.medium.com/thou-shalt-check-their-witnesses-485d2bf8375d
