...
describe("fromJson", () => {
  test("atipicial", () => {
    ...
    const manifest = ContractManifest.fromJson(atipicialManifestJson);
    expect(manifest.toJson()).toStrictEqual(atipicialManifestJson);
  });
