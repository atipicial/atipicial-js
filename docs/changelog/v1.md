...
- Ledger support
  ...
  - Add ability to sign using external function for atipicialDB API.
  - Bugfix for \_emitNum
...
- Additional AEP2 wrapper methods (Simple encrypted WIF creation)
- Address validation to guard against sending to non-ATC addresses.

  1.0.2

---

- Introduce AEP2 Support (encrypt / decrypt WIF)

  1.0.1

---

- Upgrade API support to v2 for atipicial-wallet-db
