...
function discover() {
  const timeout = setTimeout(() => {
    ...
    document.getElementById("ptxt").textContent =
      "No provider found — install a Atipicial wallet extension and reload";
  }, 5000);

  window.addEventListener(
    "Atipicial.DapiProvider.ready",
    (e) => {
  ...
  window.dispatchEvent(new Event("Atipicial.DapiProvider.request"));
}
